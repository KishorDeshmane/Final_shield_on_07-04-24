...
Feature: Partner registestration page
  ...
  Scenario: Validate that elements are present in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
  ...
  Scenario: Validate that working of an first name user field in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		...
		Then Verify that user should get the green tick in the first name user field from register as partner page
		When user enter the text into the first name user field as fifty plus "JohnSmithAndersonJohnsonWilliamsBrownDavisMillerWilsonMooreTaylorAnderson" and click on register button in register as partner page
		Then Verify that user should get the green tick in the first name user field from register as partner page
		#Invalid
		When user enter the text into the first name user field as "abc_bcde" and click on register button in register as partner page
  ...
  Scenario: Validate that working of an last name user field in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		...
		Then Verify that user should get the green tick in the last name user field from register as partner page
		When user enter the text into the last name user field as fifty plus "JohnSmithAndersonJohnsonWilliamsBrownDavisMillerWilsonMooreTaylorAnderson" and click on register button in register as partner page
		Then Verify that user should get the green tick in the last name user field from register as partner page
		#Invalid
		When user enter the text into the last name user field as "abc_bcde" and click on register button in register as partner page
  ...
  Scenario: Validate that working of an email user field in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		...
		Then Verify that user should get the red tick in the email user field from register as partner page
		When user enter the text into the email user field as "abcsd f@cocom" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the email user field from register as partner page
		When user enter the text into the email user field as "Ka+-bc.f@cocom" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the email user field from register as partner page
		When user enter the text into the email user field as "  abcd!efg@co.in  " and click on the register button in register as partner page
		Then Verify that user should get the red tick in the email user field from register as partner page
		When user enter the text into the email user field as "ab!cdefg@co.in         " and click on the register button in register as partner page
		Then Verify that user should get the red tick in the email user field from register as partner page
		When user enter the text into the email user field as "          abc!defg@co.in" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the email user field from register as partner page
  ...
  Scenario: Validate that working of an mobile number user field in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		...
		Then Verify that user should get the green tick in the mobile number user field from register as partner page
		#Invalid
		When user enter the text into the mobile number user field as space " " and click on the register button in register as partner page
		...
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
		When user enter the text into the mobile number user field as "abcdefghi" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
		When user enter the text into the mobile number user field as "12345678@" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
		When user enter the text into the mobile number user field as " 986_43  " and click on the register button in register as partner page
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
		When user enter the text into the mobile number user field as "   9876#5" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
		When user enter the text into the mobile number user field as "6*5432   " and click on the register button in register as partner page
		Then Verify that user should get the red tick in the mobile number user field from register as partner page
  ...
  Scenario: Validate that working of an password user field in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		...
		Then Verify that user should get the green tick in the password user field from register as partner page
		When user enter the text into the password user field as "Av&${}{}{}[][][]1234" and click on the register button in register as partner page
		Then Verify that user should get the green tick in the password user field from register as partner page
		When user enter the text into the password user field as "AD@@%%^^&&in@@1133@?" and click on the register button in register as partner page
		Then Verify that user should get the green tick in the password user field from register as partner page
		#invalid
		When user enter the text into the password user field as "Admin @123" and click on the register button in register as partner page
		...
		When user enter the text into the password user field as "               " and click on the register button in register as partner page
		Then Verify that user should get the red tick in the password user field from register as partner page
		When user enter the text into the password user field as "AD@@%%^^&&  in@@1122" and click on the register button in register as partner page
		Then Verify that user should get the red tick in the password user field from register as partner page
  ...
  Scenario: Validate that working of register button in the register as partner page
    Given Verify that user is on the partner registration page from landing page as expected page title "Shield - Register Partner"
		When user enter first name into the user field as "Automation" into the partner registration page
		...
		When user enter password into the user field as "Partner@123" into the partner registration page
		When user enter confirm password into the user field as "Partner@123" into the partner registration page
