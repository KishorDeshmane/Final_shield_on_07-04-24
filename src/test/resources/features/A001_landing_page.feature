...
Feature: Validate Landing Page functionality
  ...
  Scenario: Validate log in button functionality from the landing page
    Given User is on the landing page as expected page title "Shield - Home"
  ...
  Scenario: Validate register as partner button functionality from the landing page
    ...
    Then Verify that register as partner page should navigate to the registration page as expected page title "Shield - Register Partner"