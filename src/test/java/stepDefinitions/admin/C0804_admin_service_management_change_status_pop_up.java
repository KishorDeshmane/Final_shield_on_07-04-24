...
public class C0804_admin_service_management_change_status_pop_up {
	...
	Logger logger = LogManager.getLogger(C0804_admin_service_management_change_status_pop_up.class);

	
	
	
	@Given("Verify that admin user is on lookups services management change status pop up as expected page title is {string}")
	public void verify_that_admin_user_is_on_lookups_services_management_change_status_pop_up_as_expected_page_title_is(String string) {
	...
	@Then("Verify that change status text should be displayed in admin services management change status pop up")
	...
	@Then("Verify that cross button should be displayed in the admin services management change status pop up")
	...
	@Then("Verify that cross button should be clickable in the admin services management change status pop up")
	...
	@Then("Verify that switch button should be displayed in the admin services management change status pop up")
	...
	@Then("Verify that switch button should be clickable in the admin services management change status pop up")
	...
	@Then("Verify that switch button active or inactive text is displayed in the admin services management change status pop up")
	...
	@Then("Verify that close button should be displayed in the admin services management change status pop up")
	...
	@Then("Verify that close buttton should be clickable in the admin services management change status pop up")
	...
	@Then("Verify that close button should be able to mouse hover in admin services management change status pop up")
	...
	@Then("Verify that submit button should be displayed in the admin services management change status pop up")
	...
	@Then("Verify that submit button should be clickable in the admin services management change status pop up")
	...
	@Then("Verify that submit button should be able to mouse hover in admin services management change status pop up")
