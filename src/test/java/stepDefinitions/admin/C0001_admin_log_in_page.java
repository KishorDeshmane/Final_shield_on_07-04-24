...
public class C0001_admin_log_in_page {
	...
	public void verify_that_user_is_on_the_admin_log_in_page_as_expected_page_title_is(String title) {
		...
		String titlew = ElementUtil.eu.current_page_title(DriverFactory.getDriver());
		Assert.assertEquals(titlew, title);
...
//	}
	...
	public void verify_that_user_is_log_in_admin_successfully_with_the_expected_page_tilte(String title) {
		ElementUtil.eu.wait_for_to_be_title_is_displayed(DriverFactory.getDriver(), 10, title);
