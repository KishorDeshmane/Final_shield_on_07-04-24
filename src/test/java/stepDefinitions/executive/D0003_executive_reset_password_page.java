...
public class D0003_executive_reset_password_page {
	...
	private Logger logger = LogManager.getLogger(D0003_executive_reset_password_page.class);
	...
	public void verify_that_title_text_of_the_page_reset_you_password_should_be_displayed_in_reset_your_password_pagep() {
	...
	@Then("Verify that new password user field placeholder value should be {string} in executive reset your password page")
	...
	@Then("Verify that comfirm password user field placeholder value should be {string} in executive reset your password page")
	...
	@When("user enters the new password into the new password user field as {string} click on the submit button in executive reset your password page")
	...
	public void verify_that_user_click_on_sign_in_link_it_should_navigated_to_the_executive_sign_in_page() {
	...
	@When("user enters the new password into the new password user field as {string} in executive reset your password page")
	...
	@When("user enter the comfirm password into the comfirm password user field as {string} in executive reset your password page")
	...
	public void verify_that_user_is_on_the_super_executive_log_in_page_after_getting_pop_up_into_the_page() {
	    boolean actual = salogin.administrator_log_in_page_have_email_user_field_be_is_clickable();
	    Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	...
	public void verify_that_user_should_not_able_to_log_in_with_older_password_in_super_executive_log_in_page() {
	...
	@Then("Verify that user should be able to log in with new updated password {string} for executive log in page")
	...
	public void verify_that_user_should_be_able_to_set_the_older_password_into_the_userfield() {
		...
		safp.user_forget_password_enter_email_into_user_field(AppHooks.prop.getProperty("executive_email"));
...
//		salogin.mailtrap_user_click_on_log_in_button_before_scroll_down();
		...
		respass.user_enters_the_new_password_into_the_new_password_user_field(AppHooks.prop.getProperty("executive_password"));
		System.out.println("18");
		respass.user_enters_the_comfirm_password_into_the_comfirm_password_user_field(AppHooks.prop.getProperty("executive_password"));
		...
		respass.user_reset_your_password_submit_button_click();
		System.out.println("19");
		salogin.administrator_log_enter_email_into_the_user_field(AppHooks.prop.getProperty("executive_password"));
		System.out.println("19");
