...
public class D0305_executive_options_resend_email_verification_link {
...
//	private Users_all_users_change_status_pop_up_objects sastatus = new Users_all_users_change_status_pop_up_objects(DriverFactory.getDriver());
	...
	Logger logger = LogManager.getLogger(D0305_executive_options_resend_email_verification_link.class);
	...
	@Given("Verify that executive user is on the users all users actions options resend email verification link as expected page title {string} for resend email verification link")
	public void verify_that_executive_user_is_on_the_users_all_users_actions_options_resend_email_verification_link_as_expected_page_title_for_resend_email_verification_link(String title) {
	...
	@Then("Verify that executive search button is able to search the user with name of user in all users page for resend email verification link")
	public void verify_that_executive_search_button_is_able_to_search_the_user_with_name_of_user_in_all_users_page_for_resend_email_verification_link() {
	...
	@Then("executive click on the action options and click on resend email verification link button")
	public void executive_click_on_the_action_options_and_click_on_resend_email_verification_link_button() {
	...
	@Then("executive click on the resend email verification link button sent mail pop up already user is active displayed from the administrstor dashboard all users actions options button")
	public void executive_click_on_the_resend_email_verification_link_button_sent_mail_pop_up_already_user_is_active_displayed_from_the_administrstor_dashboard_all_users_actions_options_button() {
	...
	@Then("executive click on the resend email verification link button sent mail pop up email send successfully is displayed from the administrstor dashboard all users actions options button")
	public void executive_click_on_the_resend_email_verification_link_button_sent_mail_pop_up_email_send_successfully_is_displayed_from_the_administrstor_dashboard_all_users_actions_options_button() {
...
//	@Then("Verify that executive enter the first name as {string} in create user page for resend email verification link")
//	public void verify_that_executive_enter_the_first_name_as_in_create_user_page(String string) {
...
//	}
//	
//	@Then("Verify that executive enter the last name as  {string} in create user page for resend email verification link")
//	public void verify_that_super_executive_enter_the_last_name_as_in_create_user_page(String string) {
...
//	}
//	
//	@Then("Verify that executive enter the email as {string} in create user page for resend email verification link")
//	public void verify_that_super_executive_enter_the_email_as_in_create_user_page(String string) {
...
//	
//	
//	@Then("Verify that executive select the country code {string} in create user page for resend email verification link")
//	public void verify_that_super_executive_select_the_country_code_uae_in_create_user_page(String uaes) {
...
//	
//	
//	@Then("Verify that executive enter the mobile number as {string} in create user page for resend email verification link")
//	public void verify_that_executive_enter_the_mobile_number_as_in_create_user_page(String string) {
