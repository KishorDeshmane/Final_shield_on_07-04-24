...
public class D0204_executive_profile_sign_out_function {
	...
	Logger logger = LogManager.getLogger(D0204_executive_profile_sign_out_function.class);
    ...
    @Given("Verify that user is on the executive dashboard my profile dropdown page as expected page title {string}")
    public void verify_that_user_is_on_the_super_executive_dashboard_my_profile_dropdown_page_as_expected_page_title(String title) {
    ...
    public void verify_than_user_is_able_to_click_on_the_sign_out_button_from_the_executive_profile_dropdown_page() {
    ...
    public void verify_that_user_is_able_to_displayed_the_sign_in_button_from_the_executive_log_in_page() {
