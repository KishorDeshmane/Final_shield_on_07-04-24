...
public class D0203_executive_profile_change_password_page {
	...
	Logger logger = LogManager.getLogger(D0203_executive_profile_change_password_page.class);
    ...
    @Given("Verify that user is on the executive dashboard change password page as expected page title {string}")
    public void verify_that_user_is_on_the_executive_dashboard_change_password_page_as_expected_page_title(String title) {
    ...
    public void verify_that_page_header_change_password_title_text_is_displayed_from_executive_dashboard_change_password_page() {
    ...
    @Then("Verify that page current password user field placeholder value should be {string} from the executive profile pop up change password page")
    ...
    @Then("Verify that page new password userfield placeholder value should be {string} in the executive profile pop up change password second page")
    ...
    @Then("Verify that page comfirm password userfield placeholder value should be {string} in the executive profile pop up change password second page")
