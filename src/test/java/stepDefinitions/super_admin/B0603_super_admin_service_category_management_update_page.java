...
public class B0603_super_admin_service_category_management_update_page {
	...
	public void verify_that_super_admin_user_is_on_lookups_service_category_management_edit_page_as_expected_page_title_is(String title) {
	...
	public void verify_that_parent_category_search_user_field_should_be_clickable_in_the_super_admin_service_category_management_edit_page() {
		boolean actual = sascme.parent_category_search_user_field_should_be_clickable();
	    Assert.assertEquals(actual , true);
	    logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that parent category search placeholder value should be {string} in super admin service category management edit page")
	public void verify_that_parent_category_search_placeholder_value_should_be_in_super_admin_service_category_management_edit_page(String string) {
		String actual = sascme.parent_category_search_placeholder_value();
	    Assert.assertEquals(actual , string);
	    logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
