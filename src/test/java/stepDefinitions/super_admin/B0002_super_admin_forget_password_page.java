...
//	}
	...
	@When("super admin user enter only valid email and try to click on request set link in into app {string} from admin forget password log in page")
	...
	@When("super admin user enter valid email and try to click on request reset link in into application {string} in admin forget password log in page")
	...
	@When("super admin user enter invalid email and try to click on request reset link in into aplication {string} in admin forget password log in page")
	...
	public void verify_that_super_admin_user_should_get_the_expected_red_tick_in_email_user_field_in_admin_log_in_page() {
