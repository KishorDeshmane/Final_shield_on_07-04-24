...
public class B0602_super_admin_create_service_category_page {
	...
	public void verify_that_super_admin_user_is_on_lookups_create_service_category_page_as_expected_page_title_is(String title) {
	...
	public void verify_that_parent_category_search_user_field_should_be_clickable_in_the_super_admin_create_service_category_page() {
		boolean actual = sacsc.parent_category_search_user_field_should_be_clickable();
	    Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that parent category search placeholder value should be {string} in super admin create service category page")
	public void verify_that_parent_category_search_placeholder_value_should_be_in_super_admin_create_service_category_page(String string) {
		String actual = sacsc.parent_category_search_placeholder_value();
	    Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
