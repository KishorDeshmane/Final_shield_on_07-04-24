...
public class Lookups_service_category_management_create_page_objects {
	...
	@FindBy(xpath = "//*[text()='Enter parent category name']")
	private WebElement parent_category_search_user_field;
	
	@FindBy(xpath="//*[text()='Parent Category']//following-sibling::div/div/div[2]/div")
	private WebElement parent_category_dropdown_button;
	...
	public boolean parent_category_search_user_field_should_be_clickable(){
		return parent_category_search_user_field.isEnabled();
	}
	
	public String parent_category_search_placeholder_value(){
		return parent_category_search_user_field.getText();
	}
	
	
	public boolean parent_category_dropdown_should_be_clickable() {
		return parent_category_dropdown_button.isEnabled();
	}

	public void parent_category_dropdown_button_is_clicked(){
		parent_category_dropdown_button.click();
	}
